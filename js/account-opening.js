...
function renderResult(){
  ...
  if (canOpen) h+='<div style="text-align:center;margin-top:24px"><a href="https://pay.paype.cc" class="btn btn-lime btn-xl" data-open-account>Continue to full application →</a></div>';
